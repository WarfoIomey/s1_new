...
volatile uint8_t USART3_RxLen = 0;
volatile uint8_t USART3_RecvEndFlag = 0;
/* USER CODE END 0 */
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, TX_RS232_Pin|RX_RS232_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PC11     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOC, TX_WF_Pin|RX_WF_Pin);
